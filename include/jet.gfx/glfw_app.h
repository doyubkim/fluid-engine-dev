...
#ifndef INCLUDE_JET_GFX_GLFW_APP_H_
#define INCLUDE_JET_GFX_GLFW_APP_H_
...
class GlfwApp {
 public:
    ...
    //!
    //! \brief Finds Jet.Viz GLFW window object using raw GLFW window object.
    //!
    ...
    //! function should be identical to  GLFWwindowsizefun in GLFW. Unless there
    ...
    //!
    //! \code{.cpp}
    //! GlfwApp::onGlfwWindowResizedEvent() += callbackFunc;
    //! \endcode
    //!
    //! \return Event object.
    //!
...
#endif  // INCLUDE_JET_GFX_GLFW_APP_H_
