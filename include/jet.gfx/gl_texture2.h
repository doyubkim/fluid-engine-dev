...
#ifndef INCLUDE_JET_GFX_GL_TEXTURE2_H_
#define INCLUDE_JET_GFX_GL_TEXTURE2_H_
...
class GLTexture2 final : public Texture2, public GLTexture {
 public:
    ...
    void update(const ConstArrayView2<Vector4F>& data) override;

    //! Updates current texture with given 8-bit color data.
    void update(const ConstArrayView2<Vector4B>& data) override;
 ...
 private:
    ...
    void onSetTexture(const ConstArrayView2<Vector4F>& data) override;

    void onSetTexture(const ConstArrayView2<Vector4B>& data) override;
...
#endif  // INCLUDE_JET_GFX_GL_TEXTURE2_H_
