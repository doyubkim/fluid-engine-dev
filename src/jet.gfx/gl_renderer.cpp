...
GLenum convertBlendFactor(RenderStates::BlendFactor blendFactor) {
    switch (blendFactor) {
...
Texture2Ptr GLRenderer::createTexture2(const ConstArrayView2<Vector4B>& data) {
...
Texture2Ptr GLRenderer::createTexture2(const ConstArrayView2<Vector4F>& data) {
    GLTexture2* texture2 = new GLTexture2();
    texture2->setTexture(data);
...
Texture3Ptr GLRenderer::createTexture3(const ConstArrayView3<Vector4B>& data) {
...
Texture3Ptr GLRenderer::createTexture3(const ConstArrayView3<Vector4F>& data) {
    GLTexture3* texture3 = new GLTexture3();
    texture3->setTexture(data);
