...
def test_grid3():
    ...
    assert_vector_similar(tuple(a.origin), (7, 5, 3))
    assert_vector_similar(tuple(a.gridSpacing), (1, 2, 3))
    assert_bounding_box_similar(
...
def test_scalar_grid3():
    ...
    assert_vector_similar(tuple(a.origin), (9, 2, 5))
    assert_vector_similar(tuple(a.gridSpacing), (3, 4, 5))
    ...
    assert_vector_similar(tuple(b.origin), (9, 2, 5))
    assert_vector_similar(tuple(b.gridSpacing), (3, 4, 5))
    for k in range(a.resolution.z):
        for j in range(a.resolution.y):
            for i in range(a.resolution.x):
...
def test_cell_centered_scalar_grid3():
    ...
    assert_vector_similar(tuple(a.origin), (0.0, 0.0, 0.0))
    assert_vector_similar(tuple(a.gridSpacing), (1.0, 1.0, 1.0))

    a = pyjet.CellCenteredScalarGrid3((3, 4, 5), (1, 2, 3), (7, 5, 2))
    assert a.resolution == (3, 4, 5)
    assert_vector_similar(tuple(a.origin), (7, 5, 2))
    assert_vector_similar(tuple(a.gridSpacing), (1, 2, 3))
    ...
    assert a.resolution == (3, 4, 5)
    assert_vector_similar(tuple(a.origin), (7, 5, 2))
    assert_vector_similar(tuple(a.gridSpacing), (4, 4, 4))

    # Properties
    a = pyjet.CellCenteredScalarGrid3(resolution=(3, 4, 5),
                                      gridSpacing=(1, 2, 3),
                                      gridOrigin=(7, 5, 2))
    assert_vector_similar(tuple(a.dataSize), (3, 4, 5))
    assert_vector_similar(tuple(a.dataOrigin), (7.5, 6, 3.5))
    ...
    assert_vector_similar(tuple(a.origin), (1, 2, 8))
    assert_vector_similar(tuple(a.gridSpacing), (5, 9, 3))
    assert b.resolution == (3, 4, 5)
    assert_vector_similar(tuple(b.origin), (7, 5, 2))
    assert_vector_similar(tuple(b.gridSpacing), (1, 2, 3))
    for k in range(a.resolution.z):
        for j in range(a.resolution.y):
            for i in range(a.resolution.x):
                assert a[i, j, k] == 0.0
    ...
    assert_vector_similar(tuple(c.origin), (7, 5, 2))
    assert_vector_similar(tuple(c.gridSpacing), (1, 2, 3))
