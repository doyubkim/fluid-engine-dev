...
void GridBackwardEulerDiffusionSolver3::buildMarkers(
    ...
    parallelForEachIndex(_markers.size(), [&](size_t i, size_t j, size_t k) {
...
void GridBackwardEulerDiffusionSolver3::buildMatrix(const Size3& size,
    ...
    // Build linear system
    parallelForEachIndex(_system.A.size(), [&](size_t i, size_t j, size_t k) {
...
void GridBackwardEulerDiffusionSolver3::buildVectors(
    ...
    // Build linear system
    parallelForEachIndex(_system.x.size(), [&](size_t i, size_t j, size_t k) {
