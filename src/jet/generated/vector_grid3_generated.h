...
struct VectorGrid3Builder {
  ...
  flatbuffers::Offset<VectorGrid3> Finish() {
    auto o = flatbuffers::Offset<VectorGrid3>(fbb_.EndTable(start_, 4));
    return o;
  }
};
...
inline flatbuffers::Offset<VectorGrid3> CreateVectorGrid3Direct(flatbuffers::FlatBufferBuilder &_fbb,
  ...
  return CreateVectorGrid3(_fbb, resolution, gridSpacing, origin, data ? _fbb.CreateVector<double>(*data) : 0);
}
