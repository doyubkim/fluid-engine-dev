...
inline flatbuffers::Offset<PointParallelHashGridSearcher3> CreatePointParallelHashGridSearcher3Direct(flatbuffers::FlatBufferBuilder &_fbb,
  ...
  return CreatePointParallelHashGridSearcher3(_fbb, gridSpacing, resolution, points ? _fbb.CreateVector<const jet::fbs::Vector3D *>(*points) : 0, keys ? _fbb.CreateVector<uint64_t>(*keys) : 0, startIndexTable ? _fbb.CreateVector<uint64_t>(*startIndexTable) : 0, endIndexTable ? _fbb.CreateVector<uint64_t>(*endIndexTable) : 0, sortedIndices ? _fbb.CreateVector<uint64_t>(*sortedIndices) : 0);
}
