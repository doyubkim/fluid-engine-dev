...
inline flatbuffers::Offset<PointHashGridSearcher3> CreatePointHashGridSearcher3Direct(flatbuffers::FlatBufferBuilder &_fbb,
  ...
  return CreatePointHashGridSearcher3(_fbb, gridSpacing, resolution, points ? _fbb.CreateVector<const jet::fbs::Vector3D *>(*points) : 0, buckets ? _fbb.CreateVector<flatbuffers::Offset<PointHashGridSearcherBucket3>>(*buckets) : 0);
}
