...
struct VectorGrid2Builder {
  ...
  flatbuffers::Offset<VectorGrid2> Finish() {
    auto o = flatbuffers::Offset<VectorGrid2>(fbb_.EndTable(start_, 4));
    return o;
  }
};
...
inline flatbuffers::Offset<VectorGrid2> CreateVectorGrid2Direct(flatbuffers::FlatBufferBuilder &_fbb,
  ...
  return CreateVectorGrid2(_fbb, resolution, gridSpacing, origin, data ? _fbb.CreateVector<double>(*data) : 0);
}
