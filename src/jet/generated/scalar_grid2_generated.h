...
struct ScalarGrid2Builder {
  ...
  flatbuffers::Offset<ScalarGrid2> Finish() {
    auto o = flatbuffers::Offset<ScalarGrid2>(fbb_.EndTable(start_, 4));
    return o;
  }
};
...
inline flatbuffers::Offset<ScalarGrid2> CreateScalarGrid2Direct(flatbuffers::FlatBufferBuilder &_fbb,
  ...
  return CreateScalarGrid2(_fbb, resolution, gridSpacing, origin, data ? _fbb.CreateVector<double>(*data) : 0);
}
